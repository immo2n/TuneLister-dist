...
| Main Dashboard | Search & Recommendations | Core Audio Player |
| :---: | :---: | :---: |
| ![Dashboard Layout](docs/images/dashboard.png) | ![Search Page](docs/images/search.png) | ![Audio Player UI](docs/images/player.png) |
